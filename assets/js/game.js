...
(function() {
    ...
    var BACKGROUND_COLOR      = 'rgba(200,100,100,.1)',
        PARTICLE_RADIUS       = 1,
        G_POINT_RADIUS        = 10,
    ...
    mouseDown({clientX: 172,clientY: 722});
    mouseDown({clientX: 1342,clientY: 729});
    mouseDown({clientX: 181,clientY: 31});
    mouseDown({clientX: 1329,clientY: 19});
